...
public class UpdateManager {
    ...
    //存放更新APK文件的路径
    public static final String UPDATE_DOWNURL = "http://fjtmis.huijumall.com/App/Android/update/fjtmis.apk";
    //存放更新APK文件相应的版本说明路径
    public static final String UPDATE_CHECKURL = "http://fjtmis.huijumall.com/App/Android/update/update_verson.txt";
    public static final String UPDATE_APKNAME = "update_test.apk";
    //public static final String UPDATE_VERJSON = "ver.txt";
    public static final String UPDATE_SAVENAME = "fjtmis.apk";
